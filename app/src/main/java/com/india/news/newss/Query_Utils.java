...
public class Query_Utils {
    ...
    static List<News_1> parseJson(String response) {
        ArrayList<News_1> listOfNews = new ArrayList<>();
        try {
            ...
            for (int i = 0; i < resultsArray.length(); i++) {
                ...
                listOfNews.add(new News_1(webTitle, author, url, date, section));
            }
